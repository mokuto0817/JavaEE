    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          ...
          <el-col :span="24" style="height: 30px;">商品库存：{{temp.number}}件</el-col>
          <el-col :span="24" style="height: 30px;">商品标签：{{temp.label}}</el-col>
          <el-col :span="24" style="height: 30px;">商品描述：{{temp.description}}</el-col>
          <el-col :span="24" style="height: 60px;">购买数量：<el-input v-model="temp.data1" type="number" placeholder="数量" @input="data1change" @change="data1change" style="width: 80px;height: 10px;" class="filter-item" /></el-col>
          <el-col :span="24" style="height: 30px;">购买总价：{{temp.data1*temp.price}}</el-col>
        </el-col>
      </el-row>
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="createData(0)">
          加入购物车
        </el-button>
